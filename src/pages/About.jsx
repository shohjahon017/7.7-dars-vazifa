...
//         console.error("O'qituvchilarni olishda xatolik:", err);
//       });
//   }, [language]); // Til o'zgarganda qaytadan ishlatish

//   const translations = {
//     uz: {
//       title: "Bizning Maktab",
//       paragraph1: "1-IDUM – bu bilim, rivojlanish va yutuqlarning manbai.",
//       paragraph2:
//         "Maktab o‘quvchilarning shaxsiy rivojlanishi va ijtimoiy faolligini targ‘ib qiladi.",
//       paragraph3:
//         "Asosiy qadriyatlarimiz – sifatli ta’lim va doimiy rivojlanish.",
//       goal: "Bizning Maqsadlarimiz",
//       goals: [
//         "Har bir o‘quvchining qiziqishini aniqlab, uni rivojlantirish",
//         "Yuqori malakali ustozlar orqali sifatli ta’lim berish",
...
//       library: "Kutubxona",
//       studentsDesc:
//         "Maktabda 1-sinfdan 11-sinfgacha bo‘lgan 150 dan ortiq o‘quvchi tahsil oladi.",
//       libraryDesc: "Kutubxonamizda 3000 dan ortiq kitob mavjud.",
//     },
//     ru: {
//       title: "Наша Школа",
//       paragraph1: "1-IDUM – это источник знаний, развития и достижений.",
//       paragraph2:
//         "Мы поощряем развитие личности и социальную активность учеников.",
//       paragraph3:
//         "Наши ценности – качественное образование и постоянное развитие.",
//       goal: "Наши Цели",
//       goals: [
//         "Выявить интересы каждого ученика и помочь их развить",
...
//       students: "Ученики",
//       library: "Библиотека",
//       studentsDesc: "В нашей школе обучается более 150 учеников.",
//       libraryDesc: "В библиотеке более 3000 книг.",
//     },
//     en: {
//       title: "Our School",
//       paragraph1:
//         "1-IDUM is a center of knowledge, development, and achievement.",
//       paragraph2:
//         "We promote personal growth and social activity among students.",
//       paragraph3:
//         "Our core values are quality education and continuous development.",
//       goal: "Our Goals",
//       goals: [
//         "Identify each student's interest and help them grow",
...
//       students: "Students",
//       library: "Library",
//       studentsDesc: "Our school hosts over 150 students.",
//       libraryDesc: "Our library has more than 3,000 books.",
//     },
//     tj: {
//       title: "Мактаби Мо",
//       paragraph1: "1-IDUM – манбаи дониш, рушд ва дастовардҳост.",
//       paragraph2:
//         "Мо инкишофи шахсӣ ва фаъолиятҳои иҷтимоии хонандагонро ташвиқ мекунем.",
//       paragraph3: "Арзишҳои асосии мо – таҳсили босифат ва рушди пайваста.",
//       goal: "Ҳадафҳои Мо",
//       goals: [
//         "Муайян кардани шавқу завқи ҳар як хонанда",
//         "Таъмини таҳсили босифат",
//         "Истифодаи технологияҳои муосир",
//         "Ҳамкории доимӣ бо волидайн",
//       ],
//       teachers: "Омӯзгорони Мо",
//       students: "Хонандагон",
//       library: "Китобхона",
//       studentsDesc: "Дар мактаб зиёда аз 150 хонанда таҳсил мекунанд.",
//       libraryDesc: "Китобхона зиёда аз 3000 китоб дорад.",
//     },
//   };
...
function About() {
  ...
  useEffect(() => {
    const filteredTeachers = teachersData[language] || teachersData.uz;
