const teachersData = {
  uz: [
    ...
    {
      id: 9,
      name: "Abdullayev Shavkatjon",
      subject: "Ona tili va adabiyoti o'qituvchisi ",
      date: "07.01.1996",
      tel: "+998 99-307-01-96",
      img: "/abdullaev.jpg",
      bio: "Abdullayev Shavkatjon ona tili va adabiyotini  chuqur o‘rgatishga bag‘ishlangan ko‘p yillik tajribaga ega, zamonaviy metodlarni dars jarayoniga tatbiq etadi.",
    },
  ],
  ru: [
    {
    ...
    {
      id: 9,
      name: "Абдуллаев Шавкатжон",
      subject: "Учитель родного языка и литературы",
      date: "07.01.1996",
      tel: "+998 99-307-01-96",
      img: "/abdullaev.jpg",
      bio: " Абдуллаев Шавкатжон имеет многолетний опыт углубленного преподавания родного языка и литературы, применяет современные методы в учебном процессе.",
    },
  ],
  en: [
    {
    ...
    },
    {
      id: 9,
      name: "Abdullayev Shavkatjon",
      subject: "Teacher of native language and literature ",
      date: "07.01.1996",
      tel: "+998 99-307-01-96",
      img: "/abdullaev.jpg",
      bio: "Abdullayev Shavkatjon has many years of experience in in-depth teaching of native language and literature, and applies modern methods to the teaching process.",
    },
  ],
  tj: [
    {
    ...
    {
      id: 9,
      name: " Абдуллоев Шавкатҷон",
      subject: "Муаллими забони модарй ва адабиёт",
      date: "07.01.1996",
      tel: "+998 99-307-01-96",
      img: "/abdullaev.jpg",
      bio: "Абдуллоев Шавкатҷон дар таълими амиқи забони модарӣ ва адабиёт таҷрибаи чандинсола дошта, дар раванди таълим усулҳои муосирро татбиқ менамояд.",
    },
  ],
};
